    ...
    do {
        ...
        if (scenario == 1){ //Series of if-statements correlating to each scenario
            if (i == '1'){ //User chose "Lecture" option
                ...
                p.intelligence += 3;
                p.hours = (p.hours - 1 < 0) ? 0 : p.hours - 2; //Decrease 2 more hrs if lecture is chosen.
                if (p.hours == 0) {
                    p.day++;
                    p.hours = 18;
                }
                ...
                p.intelligence += 10;
                p.hours = (p.hours - 1 < 0) ? 0 : p.hours - 3; //Decrease 3 more hrs if project is chosen
                if (p.hours == 0) {
                    p.day++;
                    p.hours = 18;
                }
            ...
            if (i == '1'){
                ...
                p.intelligence += 1;
                p.hours = (p.hours - 1 < 0) ? 0 : p.hours - 2;
                if (p.hours == 0) {
                    p.day++;
                    p.hours = 18;
                }
                ...
                p.intelligence += 8;
                p.hours = (p.hours - 1 < 0) ? 0 : p.hours - 3;
                if (p.hours == 0) {
                    p.day++;
                    p.hours = 18;
                }
