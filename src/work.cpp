...
void Work::play(Player &p) {
    ...
    while (choice != '5' && p.hours>0);
		//NOTE LOGIC ERROR: Hours can end up being less than 0!
    if (p.hours<=0) {
